...
def main() -> None:
    ...
    print("  [done] 4. B1 key -> key_grabbed which=bitdw, no star_collected;")
    print("         gLastCompleted* stayed stale (course=16 star=1) (2026-06-12).")
    print("  [ ] 5. B3 grand star (level 34) → key_grabbed which=grand fires (NO")
    print("         star_collected). Fix landed 2026-06-12; re-grab to confirm live.")
    print("  [ ] 6. Walk-ins remaining: 7 (HMC), 19 (BitFS), 23 (DDD), 33 (B2);")
    print("         done 2026-06-12: 6, 16, 17, 21, 30, 34.")
