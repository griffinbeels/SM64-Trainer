# Archived project guide, 2026-09-05

Historical evidence only. The original guide below is preserved verbatim from
commit e8c795fc, including superseded instructions and local working-directory
references. It is not current policy. Start with the root CLAUDE.md and
docs/rule-index.md; consult this snapshot when investigating an incident,
old probe, or rejected approach. Paths in the original text are repo-relative.
