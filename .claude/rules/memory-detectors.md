...
| Process attach / RDRAM discovery | `memory/pj64.py` — also `rom_header()`, the cartridge header outside RDRAM, cached at the image address it last found (the poller reads it about once a second to notice a ROM swap) |
