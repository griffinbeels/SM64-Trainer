...
| The [[Scorecard]] card + its [[Goal]] picker | `ui/components/scorecard.js` + `ui/scorecardgoal.js` — **its own rule, `.claude/rules/ui-scorecard.md`** (split out 2026-09-02 when this file crossed its ceiling; the card's whole narrative lives there, unabridged) |
