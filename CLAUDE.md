...
uv run python tools/probe_host_present.py            # live gate, ANSWERED 2026-08-23: PJ64's HOST-side present counter EXISTS (heap; hunt at attach by signature: 30.00/s + phase wandering in runs vs gGlobalTimer -- 149 flips/449 frames while mirrors held 0) -- the +-1 footage wobble, visible from the RAM side at last; map v4's design rides in the docstring (read-only, safe beside a live session)
