...
| Which game frame a paused video picture shows, and the pad the timeline's panel draws for it -- a debugging CHAIN (read before editing any hop; update it in the same commit a hop moves) | `inputs/sampler.py`, `inputs/track.py`, `inputs/service.py`, `replay/ledger.py`, `replay/extract.py`, `replay/padread.py`, `replay/service.py`, `ui/frame.js`, `ui/components/inputtimeline.js` | `.claude/rules/chain-input-timeline-frame.md` |
