...
| **Imported times** — a personal best he brought rather than played (typed by hand, or a runner's Ultimate Sheet column) | `tracking/importing.py`, `library/import_runner.py`, `server/import_api.py` | `.claude/rules/import.md` |
