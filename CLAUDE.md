...
uv run python tools/probe_textbox.py                 # live gate, OPEN 2026-08-10: his King Whomp screenshots read Usamune's own screen ~8 frames faster than our textbox moment -- does ACT_WAITING_FOR_DIALOG fire before the box actually reads? Walk into any textbox; prints the WAITING->READING gap in frames off USAMUNE_OVERALL (read-only, safe beside a live session)
