...
def test_the_seeded_corpus_does_not_bloat_the_session_view(tmp_path):
    """66 seeded segments must NOT become 66 practice cards.
    ...
    with 56 route-scoped movements (Task 20 adds seg:bowser2->bits) added it
    is load-bearing, and iterating service.segment_defs here instead would
    flood the page for every user.
    """
    import json
