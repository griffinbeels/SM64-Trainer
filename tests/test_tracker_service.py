...
def test_stage_changed_is_broadcast_only_and_cached(tmp_path):
    ...
    # Only the fields this test owns -- `current_stage` is stamped with a
    # derived key (`node`) and a whole-dict comparison claims ownership of a
    # shape other work extends.
