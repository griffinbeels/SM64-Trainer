...
INVARIANTS = (
    ...
    SingleSource(
        ...
        why="Round 2, item 4's star half (live report 2026-07-31): the pinned "
            ...
            "call; stagebanner.js's RedsCell and ui/entitysection.js's "
            "displayName (the single door StarSection/SegmentSection and the "
            "practice-log's LogCard all read a card's heading through, since "
            "2026-08-03's task 2) pass identity (the star's own name + which "
