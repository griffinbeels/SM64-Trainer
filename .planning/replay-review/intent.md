...
**Feature folder:** primary checkout `.tasks/features/session-26351c84d028c40cbe12f73d/` (private planning history).
**Status:** building in `codex/replay-review`, based on main `a7ac7c4b`.
