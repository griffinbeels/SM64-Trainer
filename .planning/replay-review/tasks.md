...
- Root owns shared transport/player/downloaded integration, review-state hook and drawer, Review latest, CSS, isolated browser fixture, and integration. Existing exact stepping helpers are preserved. Full visual and focused behavioral checks on the combined tree; root reviews every returned diff.
